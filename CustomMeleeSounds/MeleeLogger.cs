...
{
    internal static class MeleeLogger
    {
        private static readonly ILog _logger = LogManager.GetLogger("Melee");

        // 快速日志级别检查（避免不必要的字符串构建）
        public static bool IsErrorEnabled => LogManager.ShouldLog("Melee", LogLevel.Error);
        public static bool IsWarningEnabled => LogManager.ShouldLog("Melee", LogLevel.Warning);
        public static bool IsInfoEnabled => LogManager.ShouldLog("Melee", LogLevel.Info);
        public static bool IsDebugEnabled => LogManager.ShouldLog("Melee", LogLevel.Debug);
        public static bool IsVerboseEnabled => LogManager.ShouldLog("Melee", LogLevel.Verbose);
